...
| Language | JavaScript (ES6+) | Cross-platform development |
| Styling | Vanilla CSS with CSS Variables | Utility-first styling |
| Routing | React Router 6 | Page-based routing |
...
**Color Palette**
- Primary: `#007AFF` (Medical blue - iOS system)
- Background: `#FFFFFF` (Light) / `#151718` (Dark)
- Surface: `#F2F2F7` (Light) / `#1E2022` (Dark)
